...
<d:grid id="dataGrid" isCellEditable="isCellEditable" height="$D.getFullHeight('dataGrid')"
        model="vivi/performance" queryForm="queryForm" autoQuery="true" forceFit="false" pagerSize="20">
    <d:toolBar>
    ...
    <d:columns>
        ...
        <d:column name="count" prompt="分数" editor="numberfield" width="250"/>
        <d:column name="add_count" prompt="加分项" editor="numberfield" width="250"/>
        <d:column name="add_count_desc" prompt="加分事由" editor="textfield" width="250"/>
        <d:column name="teacher_id" prompt="老师" width="150"  required="true" editor="combo" options="teacher_list" displayField="name" valueField="code" editable="true" />
