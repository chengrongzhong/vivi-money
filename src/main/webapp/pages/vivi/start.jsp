...
<d:form id="queryForm" title="查询条件" labelWidth="80">
    <d:line columnWidth="0.33">
        ...
        <d:field name="start_name" prompt="星级名称" anchor="100%" editor="textfield" editable="false">
            <d:event name="enter" handle="query"/>
        </d:field>
    </d:line>
</d:form>
...
<d:grid id="dataGrid" isCellEditable="isCellEditable" height="$D.getFullHeight('dataGrid')"
        model="vivi/start" queryForm="queryForm" autoQuery="true" forceFit="false" pagerSize="20">
    <d:toolBar>
    ...
    <d:columns>
        ...
        <d:column name="start_name" prompt="星级名称" editor="textfield" width="250"/>
        <d:column name="start_count" prompt="星星数量" editor="numberfield" width="200"/>
        <d:column name="money" prompt="星级奖金" editor="numberfield" width="200"/>
    </d:columns>
</d:grid>
</body>
