...
<body>
<d:initProcedure>
    <d:dataSet id="lunch_list" modelName="vivi/lunch" queryName="queryAllLunch"/>
</d:initProcedure>
...
<d:grid id="dataGrid" isCellEditable="isCellEditable" height="$D.getFullHeight('dataGrid')"
        model="vivi/lunch_att" queryForm="queryForm" autoQuery="true" forceFit="false" pagerSize="20">
    <d:toolBar>
    ...
    <d:columns>
        ...
        <d:column name="class_id" prompt="用餐区域" width="150"  required="true" editor="combo" options="lunch_list" displayField="name" valueField="code" editable="true" />
