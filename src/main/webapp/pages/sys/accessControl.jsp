...
<html>
	...
	<script type="text/javascript">
        ...
        function openAssign(id){
           DBFound.open("role_window","分配到功能",600,370,"${basePath}pages/sys/pagerAssign.jsp?ac_id="+id,function(){});
        }
	</script>
	<body>
		...
		<d:grid id="acGrid" title="url控制列表" height="$D.getFullHeight('acGrid')" queryForm="queryForm"  model="sys/accessControl" autoQuery="true" >
			<d:toolBar>
