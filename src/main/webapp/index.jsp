...
<html>
	...
	<script type="text/javascript">
		...
		function openPasswordWindow(){
			$D.open("passWordWindow","密码修改",355,185,"${basePath}pages/sys/updatePassword.jsp");
		}

		function openUserInfo(){
			$D.open("userInfoWindow","用户信息",355,235,"${basePath}pages/sys/userInfo.jsp");
		}
	</script>
	<body style="overflow: hidden">
		...
		<script type="text/javascript">
			var menuTab = new Ext.TabPanel( {
				...
				items : [ {
					...
					id : 'TAB8YM10',
					inited : true,
					url : '${basePath}pages/common/welcome.jsp',
					html : "<div style='height:100%;overflow:hidden'><iframe id='TAB8YM10_iframe' src='${basePath}pages/common/welcome.jsp' frameBorder=0 width='100%' height='100%'></iframe></div>"
				} ]
			});
		</script>
		...
		<script type="text/javascript">
			var vp=new Ext.Viewport({
				...
				items:[
					...
					{region: 'south',border: false,height: 25,html:'<div style="text-align:center;height:30px;background-color:#dfe8f6;padding:3px;">VIVI考勤后台</div>'},
					menuTree,
					menuTab
				]
			});
	    ...
	    <div style="background-color:#306091;position:absolute;top:0;left:0;z-index:1;width:100%;">
	        <div style="margin-left:0px;background-color:#306091;height:40px;font-weight:bold;line-height:30px;">
	            <span style="font-family:verdana;font-size:200%;color:#000000;font-weight:600">
                    VIVI考勤后台
                </span>
